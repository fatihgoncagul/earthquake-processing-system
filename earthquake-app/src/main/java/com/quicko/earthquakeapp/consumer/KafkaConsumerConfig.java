...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, Earthquake> consumerFactory() {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Earthquake>> factory() {
